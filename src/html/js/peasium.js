vanilla.peasium = {
    ...
    loadDocumentation: function() {
        ...
        <p>The hello controller is a simple Hello World example that purposely does not extend the base controller class. Although it could benefit from extending the base controller class, Hello World is a simple enough program that building it without the overhead is justifyable. When you visit /router.php?app=hello/home, you can see the Hello World! message. If you send a POST request with the 'name' variable through the frontend (or a helper program like Postman or SoapUI) you can customize the Hello message with your name.</p>
